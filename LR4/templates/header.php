...
<head>
    ...
    <link rel="stylesheet" href="/LR4/bootstrap/bootstrap.css">
    <title>Новая школа</title>
    <link rel="icon" href="/LR4/public/-_1.ico" type="image/x-icon"/>
</head>
<body>
    ...
    <div class="container-fluid">
        <div class="d-flex flex-nowrap align-items-center justify-content-center justify-content-lg-start">
            <a href="#" class="d-flex align-items-center mb-2 mb-lg-0 link-body-emphasis text-decoration-none me-auto">
                <img src="/LR4/public/logo.svg" alt="лого" class="img-fluid" style="height: 40px;">
            </a>
            ...
            <div class="dropdown text-end">
                <?php if (!empty($currentUser)): ?>
                    ...
                    <ul class="dropdown-menu text-small" style="">
                        ...
                        <li><a class="dropdown-item" href='../pages/groups.php'>К формочке</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li>
                            <form method="POST">
